...
export function CreateNeedScreen({
  ...
  useFormSubmitSuccess(
    state.isSaved,
    "Need request saved successfully.",
        ...
        <div className="flex flex-1 flex-col gap-5 p-4 pt-0 md:p-6 md:pt-0">
          <section className="flex items-center justify-between pt-4">
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Submit a request for equipment, supplies, or other resources.
              </p>
            </div>
            <Button
              variant="outline"
          ...
          <Card className="rounded-lg">
            <CardHeader>
              ...
              <CardDescription>
                Fill in the item details and submit for approval, or save as a
                draft.
              </CardDescription>
            </CardHeader>
            <CardContent>
