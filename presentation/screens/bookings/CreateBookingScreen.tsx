...
function toMemberOptions(branchId: string): BookingComboboxOption[] {
  ...
  return members.map((member) => ({
    ...
    searchText: [member.memberId, member.membershipNumber, member.email].filter(Boolean).join(" "),
  }))
}
...
export function CreateBookingScreen() {
  ...
  const memberOptions = useMemo(() => toMemberOptions(bookingForm.branchId), [bookingForm.branchId])
              ...
              <div className="space-y-2">
                ...
                <BookingSearchCombobox
                  ...
                  onValueChange={(branchId) =>
                    setBookingForm((previous) => ({ ...previous, branchId, memberId: "" }))
                  }
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value: "inside" | "outside") =>
                    setBookingForm((previous) => ({ ...previous, bookingType: value }))
                  }
                >
            ...
            <div className="grid gap-4 sm:grid-cols-2">
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    ...
                    >
                      ...
                      {bookingForm.dueDate ? format(bookingForm.dueDate, "MM/dd/yyyy") : "Pick a date"}
                    </Button>
                  </PopoverTrigger>
                  <PopoverContent className="w-auto p-0" align="start">
                    <Calendar
                      ...
                      onSelect={(date) =>
                        setBookingForm((previous) => ({ ...previous, dueDate: date }))
                      }
                    />
                  </PopoverContent>
                </Popover>
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(
                    value: "reserved" | "borrowed" | "returned" | "overdue" | "cancelled"
                  ) => setBookingForm((previous) => ({ ...previous, status: value }))}
                >
