...
export function EditBookingScreen({ bookingId, bookingManagementUseCase }: EditBookingScreenProps) {
      ...
      {state.isReady || state.isSaving || state.isSaved ? (
        <div className="flex flex-1 flex-col gap-5 p-4 pt-0 md:p-6 md:pt-0">
          <section className="flex items-center justify-between pt-4">
            <div>
              <h1 className="text-2xl font-semibold tracking-normal">Edit Booking</h1>
          ...
          <Card className="rounded-lg">
            <CardHeader>
              ...
              <CardDescription>Modify the booking details below.</CardDescription>
            </CardHeader>
            <CardContent>
              <BookingFormFields
                form={form}
