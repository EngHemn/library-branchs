  ...
  return (
    <>
      ...
      <CategoryFormDialog
        ...
        onOpenChange={(isOpen) => {
          if (!isOpen) viewModel.closeFormDialog()
        }}
        onSubmit={(values) => void viewModel.saveCategory(values)}
      />
      ...
      <ConcatCategoryDialog
        ...
        onOpenChange={(isOpen) => {
          if (!isOpen) viewModel.closeConcatDialog()
        }}
        onSubmit={(values) => void viewModel.concatCategories(values)}
      />
