...
export type EditStaffFormErrors = {
...
export function validateEditStaffForm(
  input: UpdateStaffInput
): Result<UpdateStaffInput> {
  const errors = getEditStaffFieldErrors(input)
...
export function getEditStaffFieldErrors(
  input: UpdateStaffInput
): EditStaffFormErrors {
  return {
